...
hand-written") and ADR-047 §(3)/(6) (the `attest` package is "hand-written and validated
...
### C-06 — Tier lattice: ADR-048 §5 and its diagram contradict ADR-044's later amendments

**Severity: High. Fix type: AMENDMENT on ADR-048 (defer lattice authority to ADR-044's amendments, with reference).**

ADR-048 §5 adds the concept tier "between foundation and transport", says "A concept
...
| C-03 | 013 (← 040 D3 × 043; Rekor v2) | High | Amendment (reconciling addendum) | Addendum in 013 |
...
| C-06 | 048 (← 044 amendments) | High | Amendment | Note on 048 §5/diagram |
...
| C-09 | 005 (× 022, INDEX rule), 029 | Medium | Amendment (revision marker) | Marker on 005; line on 029 |
