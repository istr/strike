...
// contract/attest/attestation.cue rather than being generated by `cue exp
// gengotypes`. A spike confirmed gengotypes cannot produce them: (1) the :lane
// and :deploy CUE packages co-located in one directory and gengotypes refused
// two Go packages in one directory; (2) the cross-package alias chain breaks at
// the lane -> transport
