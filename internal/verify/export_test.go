...
func NewTestTrustedMaterial(fulcioRoot, tsaRoot, tsaLeaf *x509.Certificate, logID string, rekorPub ed25519.PublicKey) *TrustedMaterial {
	fr := x509.NewCertPool()
	...
	return &TrustedMaterial{
		...
		tsaLeaf:             tsaLeaf,
		rekorKeys:           map[string]rekorKey{logID: {pub: rekorPub}},
	}
}
