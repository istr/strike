...
// packed "host:port" authority, an "https://host:port/path" URL, and a
// render-only bracket-delimited "[host]:port" pair, are projected in and out
// by the hand-written functions in internal/endpoint, not encoded in this
// type.
package endpoint
